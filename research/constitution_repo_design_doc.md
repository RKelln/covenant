...
27,476,#Constitution Repo Design Doc,references; sections
...
169,18,###3.2 `meta.yml`,dignity; definitions
193,30,##4) IDs anchors and cross-references,dignity; rights
223,38,##5) Assemblies,sections; build
225,32,###5.1 Assembly manifest format,sections; build
261,46,##6) Build pipeline,assembly; build
278,20,###6.2 Build stages,assembly; checks
307,16,##7) Validation rules,missing; assembly
323,58,##8) References / inspirations corpus,~references;slug;notes;always;license>8.6 Bibliography;8.1 Reference item types;8.3 Files per reference;8.2 Slug conventions;8.5 Notes template;8.4 Stub template
381,26,##9) Agent-facing guidance,add; added
407,22,##10) Governance & releases,artifacts; assemblies
429,37,##11) Implementation plan,add; acceptance
466,20,##12) Default content conventions,constraint; constraints
486,9,##13) Defaults used in this doc,notes; optional
495,8,##Appendix A — What to decide later,album; annotations
-->
