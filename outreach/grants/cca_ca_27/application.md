...
# Covenant
<!--
(Please maintain the tips and hints inside hidden sections, this is information from the council to help with the answers.)
-->
...
<!--
(Consider these questions as you write your answer:
	What exactly are you planning to do, and how?
	What is the artistic and/or cultural rationale for your activities?
	What are some of your inspirations?
	Does your proposed work include taking artistic risks? If so, how?
	Why is your project important at this time?
	What are the potential artistic outcomes you hope to achieve?
	How will this contribute to your or your group's artistic development?
	Does your project include any accessibility measures for artists or audiences? If so, what are they?
	Who are your intended audiences or communities? Communities might include the arts community at large, your community of practice, the cultural community or communities you belong to or that are involved in your project, etc.
	How will you engage with your intended audience or communities?
...
<!--
(Consider these questions as you write your answer:
	Have you carried out similar activities in the past?
	What activities have prepared you to undertake this work?

If you have an artistic or presenting collaborator or partner:
	Do they have relevant experience?
	How will they help you successfully carry out your project and/or reach your intended audience or communities?
	Have they confirmed their participation in your project?
...
You are responsible for:
	ensuring safe and fair working conditions for all participants in your project
	complying with any regional, national and international public health and travel measures that impact your project
)
-->
...
<!--
(Does your timeline or project plan give you enough time to carry out your project?
...
This schedule allows for iterative creation rather than a single build sprint. The project combines software development, writing, participatory design, accessibility planning, and exhibition prototyping, so each phase informs the next.


## Budget
<!--
(Your budget must include all revenues and expenses related to the project.
If you include ineligible expenses directly related to your project, you must also include other revenue sources that will cover them.
Canada Council grants are intended to be contributions towards offsetting eligible expenses. You are encouraged to include other revenue sources to contribute to covering your eligible expenses.
Your revenues should align with the grant period of the project and should not include anticipated future revenues outside of this period. Expenses incurred should also align with the grant period of the project.
Revenues and expenses that do not fit neatly can be entered in "Other" fields throughout the budget forms. Provide details in the related "Notes" field to help the assessment committee members better understand your budget.

Up to $75,000 per application, 3 applications per year. You can receive a maximum of $150,000 per year.

Your budget
	The eligible expenses for this funding opportunity are listed in the budget form. The information below gives you additional details about specific budget lines and where to enter your expenses.
	Use the Budget Notes to:
		provide context on amounts and how they were calculated
		identify if a revenue source is confirmed or pending
		include any other relevant details

Eligible expenses

Expenses directly related to your activities. All expenses must be justified and align with the delivery of the project. These can include, but are not limited to the following:
	...
	Equipment purchases specifically tied to the activity (excluding equipment related to a building). You can claim expenses:
		up to a maximum of $2,000 per item purchased
		for total combined costs of up to 15% of the requested grant amount.

Enter these expenses on the Equipment Purchase Portion Covered by Canada Council line.
	Travel costs related to the project. Enter these amounts under the Travel Expenses section.
...
Experimance:
- 2025 interactive installation at Factory Media Centre, plus print exhibitions at Tarragon Theatre and Neighbourhood Gallery.
- Visitors sculpted sand; depth sensing, real-time AI image generation, projection, sound, and a live AI voice agent responded.
- Custom Python software integrating sensors, audio, dialogue, and generative systems.
- Relevant to Covenant: proven experience with gallery-scale interactive AI installation, live conversational agents, projection, and public participation.

Feed the Fires:
- 2025 immersive installation at InterAccess with the Sôhkepayin Collective.
- Voice-based fire spirit listened to audience stories, responded in real time, and drove generative image, audio, projection, LEDs, and atmospheric effects.
- Ryan role: AI integration and custom Python software.
- Relevant to Covenant: strong precedent for voice-to-voice interaction, accessibility through spoken exchange, and participatory installation design.
-->
