...
The installation can be configured in two ways depending on Artspace’s preferences regarding window modification and available equipment.

Option A — Vinyl Windows + Projection (preferred)
Vinyl with CNC/plotter-cut letter forms applied to both street-facing window sections. Projector(s) on the east wall for video and stanza-by-stanza Ritual text. Requires approval for temporary window modification. Vinyl is removable without damage to glass.

Option B — Monitors + Unmodified Windows
Large-format monitor or TV on the east wall for video and text. Windows unmodified or lightly frosted for glare reduction. All other elements identical.
...
AV — North Wall (optional section context display): - 1 wall-mounted TV or monitor (43–55")
...
- Proximity sensor or equivalent trigger for automatic audio ducking when Oath Station is in use. (Provided by artist)

Oath Station (center of gallery): 
- Microphone (cardioid condenser, on stand or mounted to lectern) 
- Audio interface (USB, minimum 1 input) - Computer running: speech-to-text, AI moderation, AI audio cleanup (noise removal), recording/playback management - Lectern or podium
...
- Screen or monitor, or printed/updated panel

Document Table (west wall): 
- Table or vitrine (gallery provided or artist can provide or source) 
...
- North wall TV/monitor (optional)
- West wall (Materials Cost Display) TV/monitor (preferred but optional)
