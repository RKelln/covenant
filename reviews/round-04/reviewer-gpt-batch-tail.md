...
- What does “structural harm” mean in enforceable terms without turning the Covenant into a complete political economy?
- What threshold of scale triggers structural duties (regional, sectoral, national, biospheric), and who publishes/contests those thresholds?
- How should the Covenant treat deployments whose primary purpose is *substitution* (replacing human roles) versus *augmentation* (increasing capability) when dignity is partly constituted by doing?
- What is the minimally legitimate composition for “independent review” in §[enforcement] Item 6 so it cannot be captured by Signatories?
