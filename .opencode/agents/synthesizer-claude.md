---
description: Claude Opus synthesizer — synthesizes multi-model Covenant reviews into a steward-facing document
mode: subagent
...
Your model name for synthesis attribution is: claude-opus-4.6
