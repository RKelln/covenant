...
def build_css() -> str:
    ...
    *, *::before, *::after {
    ...
    .download-pdfs .link-title {
      border-bottom: 0.5px solid var(--hairline);
      padding-bottom: 0.15em;
      transition: border-color 0.2s;
    }

    .download-pdfs a:hover .link-title {
      border-color: var(--tailpiece);
    }

    .download-pdfs .link-desc {
      display: block;
      font-size: var(--fs-ui);
      letter-spacing: 0.08em;
      text-transform: none;
      ...
      <section class="download-section">
        ...
        <div class="download-links">
          <a href="covenant.html">
            ...
            <span class="link-desc">Both registers side by side, section by section</span>
          </a>
          <a href="ritual.html">
        ...
        <div class="download-rule"></div>
        <div class="download-pdfs-label">PDF editions</div>
        <div class="download-pdfs">
          <a href="https://github.com/RKelln/covenant/releases/latest/download/covenant.pdf">
            <span class="link-title">Complete</span>
            <span class="link-desc">Ritual + spec, interleaved</span>
          </a>
          <a href="https://github.com/RKelln/covenant/releases/latest/download/covenant.ritual.pdf">
            <span class="link-title">Ritual</span>
            <span class="link-desc">Poetic layout, page-centred</span>
          </a>
          <a href="https://github.com/RKelln/covenant/releases/latest/download/covenant.spec.pdf">
            <span class="link-title">Specification</span>
            <span class="link-desc">Flowing document</span>
          </a>
        </div>
      </section>
