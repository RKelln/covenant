...
106,116,###How the agentic pipeline works,~terminal;pipeline;review;reviews;build>Dynamic section discovery;Serial dispatch;Resume logic;Batching and token budgets;Focused writing passes;Output structure and concatenation;Prompt preparation;Shared code between pipeline and Terminal;Manifest-driven dispatch
222,30,##Installation kiosk: the fork-as-living-document model,~installation;amendment;cost;fork;visitor
252,124,##Technology stack,~tauri;platform;svelte;typescript;web>Git integration;Desktop application: Tauri 2.x;Document loading;Frontend: Svelte 5 + Vite + TypeScript;AI provider abstraction;Platform abstraction layer
...
493,100,##Repo structure,svelte; platform>Key structural rules
593,29,##Open questions,mode; prompts
622,96,##Suggested milestones,~council;apply;model;svelte;mode>Milestone 3 — Council panel;Milestone 5 — Kiosk mode;Milestone 2 — Single-agent Q&A;Milestone 1 — Readable document;Milestone 6 — Web deployment
653,44,###Milestone 4 — Amendment workflow,apply; council
-->
