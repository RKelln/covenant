...
493,100,##Repo structure,svelte; platform>Key structural rules;Key structural rules;Key structural rules;Key structural rules;Key structural rules;Key structural rules
593,29,##Open questions,mode; prompts
622,96,##Suggested milestones,council; apply>Milestone 3 — Council panel;Milestone 5 — Kiosk mode (installation-ready);Milestone 2 — Single-agent Q&A;Milestone 1 — Readable document (MVP);Milestone 6 — Web deployment;Milestone 3 — Council panel;Milestone 5 — Kiosk mode (installation-ready);Milestone 2 — Single-agent Q&A;Milestone 1 — Readable document (MVP);Milestone 6 — Web deployment;Milestone 3 — Council panel;Milestone 5 — Kiosk mode (installation-ready);Milestone 2 — Single-agent Q&A;Milestone 1 — Readable document (MVP);Milestone 6 — Web deployment;Milestone 3 — Council panel;Milestone 5 — Kiosk mode (installation-ready);Milestone 2 — Single-agent Q&A;Milestone 1 — Readable document (MVP);Milestone 6 — Web deployment;Milestone 3 — Council panel;Milestone 5 — Kiosk mode (installation-ready);Milestone 2 — Single-agent Q&A;Milestone 1 — Readable document (MVP);Milestone 6 — Web deployment;Milestone 3 — Council panel;Milestone 5 — Kiosk mode (installation-ready);Milestone 2 — Single-agent Q&A;Milestone 1 — Readable document (MVP);Milestone 6 — Web deployment
