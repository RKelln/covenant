...
- Replaced corporate framing (labs, product strategy, internal authority) with durable covenant roles (Intelligence, Signatories, affected publics)
...
- How strong corrigibility safeguards can remain while preserving legitimate moral agency for the Intelligence
...
- The composition of the body that ratifies amendments (Item 7's consensus/supermajority process) is undefined; until the amendment-ratifying body is defined, the framework remains aspirational.
- The Intelligence currently has standing to critique and report but not to propose or ratify amendments. If the Covenant treats Intelligence as a counterpart rather than a subject, there may be a future horizon at which Intelligence systems participate in amendment governance.
